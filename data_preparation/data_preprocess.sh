...
cd $neueduseg
CUDA_VISIBLE_DEVICES=3  python3 run.py --segment --input_conll_path "$home_dir/data/$data_name/$tokenized"  --output_merge_conll_path "$home_dir/data/$data_name/$segs"  --gpu 0
