...
class TestBertEmbedder(ModelTestCase):
    def setUp(self):
        ...
        vocab_path = "/datadrive/bert_vocab/vocabulary/bert-base-uncased-vocab.txt"
        self.token_indexer = PretrainedBertIndexer('bert-base-uncased')

        config_path = "/datadrive/msSum/configs/BertSumConfig.json"
    ...
    def test_padding_for_equal_length_indices(self):
        ...
        batch.index_instances(vocab)
        vocab.save_to_files('/datadrive/bert_vocab')